package com.andiwadi.myapplication.Adapter;
...
import com.andiwadi.myapplication.ChatMessage;
import com.andiwadi.myapplication.R;

import java.util.List;

/**
 * Created by User on 2/07/2018.
 */
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public int getViewTypeCount() {
        // my message, my image, other message,other image
        return 4;
    }
